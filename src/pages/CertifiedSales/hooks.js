...
export const usePoolList = () => {
  ...
  const upItem =
    [
      ...
      //   "proInfo": {
      //     "id": 148,
      //     "accountaddress": "0x568e82b38076475b512130c7fdf10ec49c993ff4",
      //     "proname": "ZKCHAOS",
      //     "prowebsite": "https://www.zkchaos.com/",
      //     "protheme": "Defi",
      //     "whitepaperlink": "https://www.zkchaos.com/file/Zkchaosv2.pdf",
      //     "githublink": "https://github.com/zkchaos",
      //     "twitter": "https://twitter.com/zkchaos2020",
      //     "medium": "https://zkchaos.medium.com/",
      //     "fackbook": "",
      //     "telegram": "https://t.me/zkchaos",
      //     "prosummary": "Layer2-based anonymous transaction protocol, and a fair game platform",
      //     "techhighlight": "ZKCHAOS is based on layer2 through ZK-Rollup technology, provides unlimited scalability and privacy. It provides a high-performance anonymous trading for token holders on multi-chain, and transactions in ZKCHAOS nearly do not require any gas fees.",
      //     "architecture": "1",
      //     "attachmenturl": "",
      //     "teambio": "The team is led by a PhD in cryptography, with members from a number of well-known Internet companies, and has in-depth research in smart contracts and zero-knowledge proofs. With years of experience in Ethereum and eos development, the team has developed many blockchain games",
      //     "totalsupply": "100000000",
      //     "circulatingsupply": "2640000",
      //     "tokenticketer": "CHAOS",
      //     "tokencontractaddress": "0xa23f73d672f2b34cb507b4a3bdca62f949769726",
      //     "tokendistribution": "Protocol Rewards - 42%\nFoundation - 18%\nLiquidity - 4%\nTeam - 15%\nAdvisors - 5%\nSeed - 5%\nPrivate - 10%\nPublic - 1%",
      //     "tokenlookupschedule": "2.64% unlocked at TGE, \nTeam tokens will have a 12-month lockup followed by a 12-month linear vesting period.\nSeed & private sale tokens will have a 3-month lockup followed by a linear vesting schedule.\nAnd See the whitepaper for specific lockup rules",
      //     "auctiontype": "Fixed Swap Auction on Binance Smart Chain",
      //     "amountoftoken": "320000",
      //     "pricepertoken": "0.25",
      //     "allocationperwallet": "100 USDT",
      //     "auctiontime": "14400",
      //     "teamwallet": "0x90bAbde2c3afA541F3779a031B69bDe246b90A79",
      //     "ifkyc": 0,
      //     "ifwhitelist": 1,
      //     "contactemail": "p1@zkchaos.com",
      //     "additionalinfo": "",
      //     "prologourl": "9d570d8bccdc5bcfafbca81d73d7fe1e.png",
      //     "created_at": "2021-06-09T05:57:22Z",
      //     "updated_at": "2021-06-09T05:57:22Z"
      //   }
      // }
      // , {
      //   notReady: true,
